...
import { PawPathProvider } from "../lib/pawpath/store";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "PawPath Learning — Adopt a Puppy, Learn Math & English" },
      { property: "og:description", content: "PawPath Learning is a fun app for Grades 3–5. Adopt a puppy, go on learning adventures, and grow in Math, English, and Science." },
      { name: "twitter:description", content: "PawPath Learning is a fun app for Grades 3–5. Adopt a puppy, go on learning adventures, and grow in Math, English, and Science." },
    ],
    links: [
      {
        rel: "stylesheet",
